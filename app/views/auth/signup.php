...
<?php endif; ?>
            <form class="login-form" id="signupForm" method="POST" action="<?= htmlspecialchars($basePath . '/signup', ENT_QUOTES, 'UTF-8') ?>">
            ...
            <div class="register-section">
                <p>Already have an account? <a href="<?= htmlspecialchars($basePath . '/login', ENT_QUOTES, 'UTF-8') ?>" class="register-link">Login</a></p>
            </div>
        </div>
